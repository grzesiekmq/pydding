...
print('diagonal difference:', math_extended.diagonal_difference([[1, 2, 3],[4, 5, 6],[9, 8, 9]]))
...
print('distance:', math_extended.get_distance({'x': -2, 'y': -2}, {'x': 4, 'y': 3}))
print('is circle collide:', math_extended.is_circle_collision([2, 2, 1], [5, 5, 10]))
